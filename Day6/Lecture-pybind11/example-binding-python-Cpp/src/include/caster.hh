...
namespace pybind11 { namespace detail {
    template <typename ArrayType> struct gen_type_caster_arr {
    public:
    ...
    template <>
    struct type_caster<std::shared_ptr<arrow::DoubleArray>> : public gen_type_caster_arr<arrow::DoubleArray> {
    };
