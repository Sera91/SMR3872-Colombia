...
from PySVM.base import clone, is_classifier
from PySVM.datasets import load_diabetes, make_regression
from PySVM.exceptions import ConvergenceWarning
from PySVM.linear_model import (
    ElasticNet,
    ElasticNetCV,
    Lars,
    Lasso,
...
from PySVM.linear_model._coordinate_descent import _set_order
from PySVM.model_selection import (
    GridSearchCV,
    LeaveOneGroupOut,
    train_test_split,
)
from PySVM.pipeline import make_pipeline
from PySVM.preprocessing import StandardScaler
from PySVM.utils import check_array
...
def test_lasso_cv_with_some_model_selection():
    ...
    from PySVM.model_selection import ShuffleSplit
...
def test_lassoCV_does_not_set_precompute(monkeypatch, precompute, inner_precompute):
    ...
    monkeypatch.setattr("PySVM.linear_model._coordinate_descent.Lasso", LassoMock)
