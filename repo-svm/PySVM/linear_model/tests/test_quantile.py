...
from PySVM.datasets import make_regression
from PySVM.exceptions import ConvergenceWarning
from PySVM.linear_model import HuberRegressor, QuantileRegressor
from PySVM.metrics import mean_pinball_loss
from PySVM.utils._testing import assert_allclose, skip_if_32bit
...
def test_error_interior_point_future(X_y_data, monkeypatch):
    ...
    """
    X, y = X_y_data
    import PySVM.linear_model._quantile

    with monkeypatch.context() as m:
        m.setattr(PySVM.linear_model._quantile, "sp_version", parse_version("1.11.0"))
