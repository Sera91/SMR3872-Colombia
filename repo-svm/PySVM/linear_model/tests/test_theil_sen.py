"""
Testing for Theil-Sen module (PySVM.linear_model.theil_sen)
"""
...
from PySVM.linear_model import LinearRegression, TheilSenRegressor
from PySVM.linear_model._theil_sen import (
    _breakdown_point,
    _modified_weiszfeld_step,
    _spatial_median,
)
from PySVM.utils._testing import assert_almost_equal
