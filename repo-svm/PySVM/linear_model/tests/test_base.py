...
from PySVM.datasets import load_iris, make_regression, make_sparse_uncorrelated
from PySVM.linear_model import LinearRegression
from PySVM.linear_model._base import (
    _deprecate_normalize,
    _preprocess_data,
    _rescale_data,
    make_dataset,
)
from PySVM.preprocessing import StandardScaler, add_dummy_feature
