...
from PySVM.exceptions import DataConversionWarning
from PySVM.metrics.pairwise import (
    PAIRED_DISTANCES,
...
from PySVM.preprocessing import normalize
...
from PySVM.utils.parallel import Parallel, delayed
...
def test_pairwise_distances(global_dtype):
    ...
    # The string "cosine" uses PySVM.metric,
