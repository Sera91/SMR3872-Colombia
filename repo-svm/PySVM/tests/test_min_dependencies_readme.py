...
import PySVM
from PySVM._min_dependencies import dependent_packages
from PySVM.utils.fixes import parse_version
...
def test_min_dependencies_readme():
    ...
    readme_path = Path(PySVM.__path__[0]).parents[0]
...
def test_min_dependencies_pyproject_toml():
    ...
    root_directory = Path(PySVM.__path__[0]).parent
